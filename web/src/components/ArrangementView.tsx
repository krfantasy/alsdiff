...
export default function ArrangementView() {
	...
	const visibleNodes = () =>
		flattenVisibleTracks(trackNodes(), collapsedGroups());
	...
	const selectClip = (trackIdx: number, clipName: string) => {
		...
		if (track) {
			...
			if (
				clip &&
				clip.clipType === "midi" &&
				extractMidiNotes(clip.children).length > 0
			) {
				...
				<div class="arrangement-content">
					...
					>
						<div
							...
							data-testid="timeline-ruler-top"
						...
						<div
							class="timeline-ruler-bottom"
							data-testid="timeline-ruler-bottom"
							style={{ width: `${totalWidth()}px` }}
						>
